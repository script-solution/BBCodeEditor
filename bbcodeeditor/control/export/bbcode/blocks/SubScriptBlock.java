 ...
 * @author hrniels
 */
public class SubScriptBlock extends Block {
	 ...
	 */
	public SubScriptBlock(Block parent,SimpleTag openingTag,SimpleTag closingTag) {
	...
	public void parseContent(Controller con,TextAttributes attributes,List allowedTypes,
		...
		if(_openingTag != null) {
			if(allowedTypes.contains(TYPE_INLINE))
				attributes.set(TextAttributes.POSITION,new Byte(TextAttributes.POS_SUBSCRIPT));
