 ...
 *
 */
public class FontFamilyBlock extends Block {
	 ...
	 */
	public FontFamilyBlock(Block parent,ExtendedTag openingTag,ExtendedTag closingTag) {
		super(parent,openingTag,closingTag);
	}

	protected void checkValue() {
		_openingTag.setValue(TextAttributes.getValidValueFor(
				TextAttributes.FONT_FAMILY,_openingTag.getValue()));
	}
}