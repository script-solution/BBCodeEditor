 ...
 *
 */
public class FontSizeBlock extends Block {
	 ...
	 */
	public FontSizeBlock(Block parent,ExtendedTag openingTag,ExtendedTag closingTag) {
		super(parent,openingTag,closingTag);
	}

	protected void checkValue() {
		String input = (String)_openingTag.getValue();
		_openingTag.setValue(TextAttributes.getValidValueFor(TextAttributes.FONT_SIZE,input));
	}
}