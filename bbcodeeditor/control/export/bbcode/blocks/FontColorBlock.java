 ...
 *
 */
public class FontColorBlock extends Block {
	 ...
	 */
	public FontColorBlock(Block parent,ExtendedTag openingTag,ExtendedTag closingTag) {
		super(parent,openingTag,closingTag);
	}

	protected void checkValue() {
		_openingTag.setValue(TextAttributes.getValidValueFor(
				_openingTag.getAttribute(),_openingTag.getValue()));
	}
}