...
/**
 * The new-button for the toolbar
 * 
 * @author hrniels
 */
public class NewButton extends JButton implements ActionListener {
	 ...
	 */
	public NewButton(AbstractTextField textArea) {
		super(new ImageIcon(Helper.getFileInDocumentBase("./images/new.png")));
		
		_textArea = textArea;
		
		setToolTipText(LanguageContainer.getText(Language.GUI_BTN_NEW_TOOLTIP));
		addActionListener(this);
	}

	public void actionPerformed(ActionEvent e) {
		int res = JOptionPane.showConfirmDialog(_textArea,
				LanguageContainer.getText(Language.GUI_DIALOG_NEW_MESSAGE),
				LanguageContainer.getText(Language.GUI_DIALOG_NEW_TITLE),
