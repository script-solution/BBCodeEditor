...
/**
 * The font-color-button for the button-bar
 * 
 * @author hrniels
 */
public class FontColorButton extends ColorButton implements ActionListener {
	 ...
	 */
	public FontColorButton(AbstractTextField textArea) {
		super("F",Color.BLACK);
		
		_textArea = textArea;
		
		setToolTipText(LanguageContainer.getText(Language.GUI_BTN_FONTCOLOR_TOOLTIP));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(newColor != null) {
			setColor(newColor);
			_textArea.setAttribute(TextAttributes.FONT_COLOR,newColor);
		}
