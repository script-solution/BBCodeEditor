...
/**
 * The copy-button for the toolbar
 * 
 * @author hrniels
 */
public class CopyButton extends JButton implements ActionListener {
	 ...
	 */
	public CopyButton(AbstractTextField textArea) {
		super(new ImageIcon(Helper.getFileInDocumentBase("./images/copy.png")));
		
		_textArea = textArea;
		
		setToolTipText(LanguageContainer.getText(Language.GUI_BTN_COPY_TOOLTIP));
		addActionListener(this);
	}

	public void actionPerformed(ActionEvent e) {
		_textArea.copySelectedText();
