...
/**
 * The paste-button for the toolbar
 * 
 * @author hrniels
 */
public class PasteButton extends JButton implements ActionListener {
	 ...
	 */
	public PasteButton(AbstractTextField textArea) {
		super(new ImageIcon(Helper.getFileInDocumentBase("./images/paste.png")));
		
		_textArea = textArea;
		
		setToolTipText(LanguageContainer.getText(Language.GUI_BTN_PASTE_TOOLTIP));
		addActionListener(this);
	}

	public void actionPerformed(ActionEvent e) {
		_textArea.pasteTextAtCursor();
