...
/**
 * The cut-button for the toolbar
 * 
 * @author hrniels
 */
public class CutButton extends JButton implements ActionListener {
	 ...
	 */
	public CutButton(AbstractTextField textArea) {
		super(new ImageIcon(Helper.getFileInDocumentBase("./images/cut.png")));
		
		_textArea = textArea;
		
		setToolTipText(LanguageContainer.getText(Language.GUI_BTN_CUT_TOOLTIP));
		addActionListener(this);
	}

	public void actionPerformed(ActionEvent e) {
		_textArea.cutSelectedText();
